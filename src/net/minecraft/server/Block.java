...
public class Block {
    ...
    public static final Block WATER = (new BlockFluidFlowing(8, Material.WATER)).c(100.0F).f(3).a("water").n();
    public static final Block STATIONARY_WATER = (new BlockFluidStill(9, Material.WATER)).c(100.0F).f(3).a("water").n();
    public static final Block LAVA = (new BlockFluidFlowing(10, Material.LAVA)).c(0.0F).a(1.0F).f(255).a("lava").n();
    public static final Block STATIONARY_LAVA = (new BlockFluidStill(11, Material.LAVA)).c(100.0F).a(1.0F).f(255).a("lava").n();
    ...
    public static final Block LIME_WOOL = (new Block(24, 67, Material.CLOTH)).c(0.8F).a(k).a("cloth");
    public static final Block GREEN_WOOL = (new Block(25, 68, Material.CLOTH)).c(0.8F).a(k).a("cloth");
    public static final Block AQUA_GREEN_WOOL = (new Block(26, 69, Material.CLOTH)).c(0.8F).a(k).a("cloth");
    public static final Block CYAN_WOOL = (new Block(27, 70, Material.CLOTH)).c(0.8F).a(k).a("cloth");
    public static final Block BLUE_WOOL = (new Block(28, 71, Material.CLOTH)).c(0.8F).a(k).a("cloth");
    public static final Block INDIGO_WOOL = (new Block(29, 72, Material.CLOTH)).c(0.8F).a(k).a("cloth");
    public static final Block PURPLE_WOOL = (new Block(30, 73, Material.CLOTH)).c(0.8F).a(k).a("cloth");
    public static final Block VIOLET_WOOL = (new Block(31, 74, Material.CLOTH)).c(0.8F).a(k).a("cloth");
    public static final Block MAGENTA_WOOL = (new Block(32, 75, Material.CLOTH)).c(0.8F).a(k).a("cloth");
    public static final Block PINK_WOOL = (new Block(33, 76, Material.CLOTH)).c(0.8F).a(k).a("cloth");
    ...
    public static final Block WATER_SOURCE = new BlockFluidSource(52, Block.WATER.id).c(0.0f).a(e);
    public static final Block LAVA_SOURCE = new BlockFluidSource(53, Block.LAVA.id).c(0.0f).a(e);
    ...
    public static final Block GEAR = (new BlockGears()).c(0.5F).a(i).a("gear").n();
